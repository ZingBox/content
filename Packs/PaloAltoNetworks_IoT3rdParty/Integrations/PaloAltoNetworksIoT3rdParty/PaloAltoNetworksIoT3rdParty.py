...
def convert_asset_to_external_format():
    ...
    prefixMap = {
        "Device": {
            ...
            "ServiceNow": "PanwIot3rdParty.DeviceSN"
        },
        "Alert": {
            "SIEM": "PanwIot3rdParty.AlertCEFSyslogs",
            "ServiceNow": "PanwIot3rdParty.AlertSN"
        },
        "Vulnerability": {
            "SIEM": "PanwIot3rdParty.VulnerabilityCEFSyslogs",
            "ServiceNow": "PanwIot3rdParty.VulnerabilitySN"
        }
    }
    ...
    if asset_list:
        ...
        readable_res = "Converted an %s has zb_ticketid %s to %s" % (
            asset_type, demisto.args().get('incident')['correlation_id'], output_format)
    return CommandResults(
