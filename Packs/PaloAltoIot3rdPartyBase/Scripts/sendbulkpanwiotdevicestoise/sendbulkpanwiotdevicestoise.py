...
def get_active_ise_instance():
    ...
    response = demisto.executeCommand("panw_iot_get_active_ise_instance", {})
    err_msg = None
    ...
    if 'PaloAltoIoTIntegrationBase.ActiveNodeInstance' in data:
        active_instance = data['PaloAltoIoTIntegrationBase.ActiveNodeInstance']
    elif 'PaloAltoIoTIntegrationBase.NodeErrorStatus' in data:
        err_msg = data['PaloAltoIoTIntegrationBase.NodeErrorStatus']
...
while True:
    ...
    try:
        ...
        for device_map in device_list:
            if 'mac_address' in device_map:
                ...
                if isError(resp[0]):
                    ...
                    # this means the endpoint was not found or we received empty results..
        ...
        return_results("Failed to parse device map %s" % str(ex))
